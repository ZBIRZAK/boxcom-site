  ...
  return (
    <>
      ...
      <link
        ...
        href={host + "/wp-includes/blocks/navigation/style.min.css?ver=6.8.2"}
        media="all"
      />
      ...
      <link
        ...
        href={host + "/wp-includes/blocks/image/style.min.css?ver=6.8.2"}
        media="all"
      />
      ...
      <link
        ...
        href={
          host + "/wp-includes/css/dist/block-library/common.min.css?ver=6.8.2"
        }
        media="all"
      />
...
`}
      ...
      <style id="block-style-variation-styles-inline-css">
        ...
        :root :where(.is-style-post-terms-1--2 a:where(:not(.wp-element-button)):hover) {
      ...
      {/* <link
        ...
        href={host + "/wp-content/themes/twentytwentyfive/style.css?ver=1.3"}
        media="all"
      /> */}
    </>
  );
