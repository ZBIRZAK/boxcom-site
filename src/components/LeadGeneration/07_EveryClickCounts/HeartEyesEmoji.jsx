...
const HeartEyesEmoji = () => {
  ...
  return (
    <div className="absolute w-[20%] md:right-[-100%] right-[10%] md:bottom-[10%] bottom-[20%]">
      <img
      ...
      <img
        ...
        className="absolute md:top-[25%] top-[30%] left-[10%] md:w-11 w-5"
      />
      <img
        ref={refEye2}
        src="/images/smiley/heart-eye.svg"
        className="absolute ld:top-[25%] top-[27%] right-[10%] md:w-11 w-5"
      />
    </div>
  );
};
