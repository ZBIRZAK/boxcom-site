...
export default function Sparkles({
  ...
  useEffect(() => {
    ...
    // GSAP animation
    const sparkleContainer = sparklesContainerRef.current;
    ...
    tl.set(sparkleContainer, { opacity: 0 });
    tl.to(sparkleContainer, {
      delay: 5,
      opacity: 1,
      duration: 0.5,
      ease: "power1.in",
  ...
  return (
    <div ref={sparklesContainerRef} className={clsx("absolute", className)}>
      <svg
      ...
      >
        <style>{`
          .spark { transform-origin: 0 0; animation: fly 900ms cubic-bezier(.2,.9,.2,1) infinite; opacity: 0; }
          .star { transform-origin: 0 0; animation: twinkle 850ms ease-in-out infinite; }
          @keyframes fly {
